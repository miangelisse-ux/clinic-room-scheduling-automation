...
Form submission triggers onFormSubmit

Lock acquired to prevent simultaneous double-booking

Room availability checked with buffer window

If requested room unavailable → next available room assigned

Event created in appropriate Google Calendar

Confirmation email sent to therapist

Daily summary emails generated per therapist
